//^ This functions to get all corners points of a Rect
...
//^ This function check if a rect is in another rect using the function to get corners points and pointIsInRect and return an array with the corner who is in the other rect
